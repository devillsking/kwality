...
<head>
    ...
    <meta charset="utf-8" />
    <title>Kwality Construction Admin</title>
                ...
                <div class="dropdown ms-1 topbar-head-dropdown header-item">
                    ...
                    <div class="dropdown-menu dropdown-menu-end">
                        ...
                        <a href="javascript:void(0);" class="dropdown-item notify-item language" data-lang="gr"
                            title="German">
                            <img src="asset/images/flags/germany.svg" alt="user-image" class="me-2 rounded"
                    ...
                    <ul class="navbar-nav" id="navbar-nav">
                        ...
                        <li class="nav-item">
                            ...
                            <div class="collapse menu-dropdown" id="sidebarApps">
                                <ul class="nav nav-sm flex-column">
                                    <li class="nav-item">
                                        <a href="{{route('plan.view')}}" class="nav-link" data-key="t-calendar">Plans </a>
                                    </li>
                                    <li class="nav-item">
                                        <a href="{{route('plan.form')}}" class="nav-link" data-key="t-chat"> Create Plans </a>
                                    </li>
                                 </ul>
                            </div>
                        </li>
                        <li class="nav-item">
                            ...
                            <div class="collapse menu-dropdown" id="banner">
                                <ul class="nav nav-sm flex-column">
                                    <li class="nav-item">
                                        <a href="{{route('banner.view')}}" class="nav-link" data-key="t-calendar">Banner </a>
                                    </li>
                                    <li class="nav-item">
                                        <a href="{{route('banner.form')}}" class="nav-link" data-key="t-chat"> Create Banner </a>
                                    </li>
                                 </ul>
                            </div>
                        </li>
